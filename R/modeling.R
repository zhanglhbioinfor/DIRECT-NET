...
#' @export
Run_DIRECT_NET <- function(object, k_neigh = 50, atacbinary = TRUE, max_overlap=0.8, size_factor_normalize = TRUE, genome.info, focus_markers, params = NULL,HF_cutoff = NULL, LF_cutoff = NULL, seed = 123, verbose = TRUE) {
  ########################################################### step 1. Aggregation
  if (verbose)  {
