...
Data <- readRDS(file = "/Users/suoqinjin/Downloads/DIRECTNET/Brain/Data/GSE147672_200324_Brain_scATAC_SummarizedExperiment_forGEO")
...
library(readxl)
Umap_info <- read_excel("/Users/suoqinjin/Downloads/DIRECTNET/Brain/Data/41588_2020_721_MOESM5_ESM.xlsx",skip = 21)
#head(Umap_info)
...
genome.info <- read.table(file = "/Users/suoqinjin/Downloads/DIRECTNET/Brain/Data/hg38.promoter.regions.txt")
...
markers <- read.table("/Users/suoqinjin/Downloads/DIRECTNET/Brain/Data/Brain_markers.txt", sep = "\t")
...
```{r,message=FALSE,warning=FALSE}
combined <- Run_DIRECT_NET(combined, k_neigh = 50, atacbinary = TRUE, max_overlap=0.5, size_factor_normalize = TRUE, genome.info, focus_markers = "FEV")
...
load("/Users/suoqinjin/Downloads/DIRECTNET/Brain/Data/Brain_direct.net.RData")
```
